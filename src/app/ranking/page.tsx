      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-10 pb-20">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          ...
          <div className="flex-shrink-0">
            <a href="/api/auth/steam" className="inline-flex items-center gap-4 bg-gradient-to-r from-white/[0.03] to-white/[0.08] border border-white/10 hover:border-red-500/30 hover:from-red-950/20 hover:to-red-900/10 px-6 py-4 rounded-2xl text-base font-bold transition-all group backdrop-blur-sm shadow-xl">
